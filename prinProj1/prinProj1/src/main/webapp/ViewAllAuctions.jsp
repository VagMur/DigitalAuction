...
<body>
 	 ...
 	 <%
		...
		ResultSet result1 = stmt1.executeQuery(
			    ...
			    "WHERE a.startingTime <= NOW() AND a.closingTime >= NOW()"
			);
		
		out.println("<b>Current Live Auctions:</b><br/>");
		...
		out.println("<th style='border: 1px solid #dddddd; text-align: left; padding: 8px;' onclick='sortTable(\"currAuctionsTable\",14)'>Seller ID</th>");
		...
		while (result1.next()) {
		    ...
		    out.print("</td><td style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>");
		    out.print(result1.getString("addedBySellerInfo"));
		    out.println("</td></tr>");
		}
		...
		out.println("<th style='border: 1px solid #dddddd; text-align: left; padding: 8px;' onclick='sortTable(\"futureAuctionsTable\",11)'>Seller ID</th>");
		out.println("</tr>");
		while (result2.next()) {
		    out.println("<tr>");
		    out.print("<td style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>");
		    ...
		    out.print("</td><td style='border: 1px solid #dddddd; text-align: left; padding: 8px;'>");
		    out.print(result2.getString("addedBySellerInfo"));
		    out.println("</td></tr>");
		}
		out.println("</table><br/><br/>");
