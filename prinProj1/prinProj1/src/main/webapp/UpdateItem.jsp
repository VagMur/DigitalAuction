...
<body>
 	...
 	<%
		...
		out.println("<form action='VerifyUpdateItem.jsp' method='POST'>");
		out.println("<table>");
		...
		out.println("<tr><td>Color:</td><td><input type='text' name='desc1' required/></td></tr>");
		out.println("<tr><td>Weight:</td><td><input type='text' name='desc2' required/></td></tr>");
		out.println("<tr><td>Screen Size:</td><td><input type='text' name='desc3' required/></td></tr>");
